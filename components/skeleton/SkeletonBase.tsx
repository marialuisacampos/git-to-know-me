...
export function SkeletonPulse({ className = "" }: SkeletonProps) {
  return (
    <div
      className={`bg-slate-700/55 rounded-lg animate-pulse ${className}`}
      aria-hidden="true"
    />
  );
}
...
export function SkeletonCard({
  ...
  return (
    <div
      className={`bg-slate-900/45 backdrop-blur-xl border border-slate-700/60 rounded-xl p-5 ${className}`}
    >
      {children}
    </div>
  );
  ...
  return (
    <SkeletonCard className="animate-pulse">
      <div className="space-y-3">
        ...
        <SkeletonText className="w-20 bg-slate-700/50" />
        <div className="flex gap-1.5">
          <SkeletonPulse className="h-5 w-16 bg-slate-700/50" />
          <SkeletonPulse className="h-5 w-16 bg-slate-700/50" />
        </div>
        <div className="flex gap-2 pt-1">
          <SkeletonButton className="w-20 bg-slate-700/60" />
          <SkeletonButton className="w-20 bg-slate-700/60" />
        </div>
      </div>
    </SkeletonCard>
...
export function SkeletonPostCard() {
  return (
    <SkeletonCard className="animate-pulse">
      <div className="space-y-3">
        <SkeletonText className="w-28 bg-slate-700/50" />
        <SkeletonPulse className="h-5 w-3/4" />
        <SkeletonText className="w-full bg-slate-700/50" />
        <SkeletonText className="w-2/3 bg-slate-700/50" />
        <div className="flex gap-1.5">
          <SkeletonPulse className="h-5 w-16 bg-slate-700/50" />
          <SkeletonPulse className="h-5 w-16 bg-slate-700/50" />
        </div>
  ...
  return (
    <SkeletonCard className="p-6 md:p-8 rounded-xl shadow-xl">
      <div className="space-y-3 pb-6 mb-6 border-b border-slate-800/50 animate-pulse">
        <SkeletonText className="w-32 bg-slate-700/50" />
      ...
      <div className="space-y-4 animate-pulse">
        <SkeletonText className="w-full bg-slate-700/50" />
        <SkeletonText className="w-5/6 bg-slate-700/50" />
        <SkeletonText className="w-4/5 bg-slate-700/50" />
        <SkeletonText className="w-full bg-slate-700/50" />
        <SkeletonText className="w-3/4 bg-slate-700/50" />
      </div>
    </SkeletonCard>
  );
}
